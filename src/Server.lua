...
function Server.error(err)
	error(err or "", 3)
end

function Server:sendError(err)
	Server.error(err)
...
function Server:bind(type, fn, private)
...
function Server:loadModule(path)
...
function Server:loadModules(modules)
